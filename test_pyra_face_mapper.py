...
def test_convert_vertex_twist_to_face_twist_r():
    ...
    expected_face_moves = ["Lw [R]", "Lw' [R']", "Lw2 [R2]", "Lw'2 [R'2]", "Lw2' [R2']"]
    for v, e in zip(vertex_moves, expected_face_moves):
        assert PyraFaceMapper.convert_vertex_twist_to_face_twist(v) == e
    vertex_moves = ["r", "r'", "r2", "r'2", "r2'"]
    expected_face_moves = ["2Lw [R]", "2Lw' [R']", "2Lw2 [R2]", "2Lw'2 [R'2]", "2Lw2' [R2']"]
    for v, e in zip(vertex_moves, expected_face_moves):
        assert PyraFaceMapper.convert_vertex_twist_to_face_twist(v) == e
...
def test_convert_vertex_twist_to_face_twist_l():
    ...
    expected_face_moves = ["Rw [L]", "Rw' [L']", "Rw2 [L2]", "Rw'2 [L'2]", "Rw2' [L2']"]
    for v, e in zip(vertex_moves, expected_face_moves):
        assert PyraFaceMapper.convert_vertex_twist_to_face_twist(v) == e
    vertex_moves = ["l", "l'", "l2", "l'2", "l2'"]
    expected_face_moves = ["2Rw [L]", "2Rw' [L']", "2Rw2 [L2]", "2Rw'2 [L'2]", "2Rw2' [L2']"]
    for v, e in zip(vertex_moves, expected_face_moves):
        assert PyraFaceMapper.convert_vertex_twist_to_face_twist(v) == e
...
def test_convert_vertex_twist_to_face_twist_b():
    ...
    expected_face_moves = ["Fw [B]", "Fw' [B']", "Fw2 [B2]", "Fw'2 [B'2]", "Fw2' [B2']"]
    for v, e in zip(vertex_moves, expected_face_moves):
        assert PyraFaceMapper.convert_vertex_twist_to_face_twist(v) == e
    vertex_moves = ["b", "b'", "b2", "b'2", "b2'"]
    expected_face_moves = ["2Fw [B]", "2Fw' [B']", "2Fw2 [B2]", "2Fw'2 [B'2]", "2Fw2' [B2']"]
    for v, e in zip(vertex_moves, expected_face_moves):
        assert PyraFaceMapper.convert_vertex_twist_to_face_twist(v) == e
...
def test_convert_vertex_twist_to_face_twist_u():
    ...
    expected_face_moves = ["Dw [U]", "Dw' [U']", "Dw2 [U2]", "Dw'2 [U'2]", "Dw2' [U2']"]
    for v, e in zip(vertex_moves, expected_face_moves):
        assert PyraFaceMapper.convert_vertex_twist_to_face_twist(v) == e
    vertex_moves = ["u", "u'", "u2", "u'2", "u2'"]
    expected_face_moves = ["2Dw [U]", "2Dw' [U']", "2Dw2 [U2]", "2Dw'2 [U'2]", "2Dw2' [U2']"]
    for v, e in zip(vertex_moves, expected_face_moves):
        assert PyraFaceMapper.convert_vertex_twist_to_face_twist(v) == e
